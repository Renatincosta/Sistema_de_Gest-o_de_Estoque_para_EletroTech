...
public class MovimentacaoEstoqueDAO {
    ...
    public MovimentacaoEstoque buscarPorId(int id) throws SQLException {
        String sql = "SELECT me.id, p.nome as produto, f.nome as fornecedor,me.data,me.Quantidade,me.Tipo_Movimentacao,me.Custo,me.Lote,me.Validade FROM Movimentacao_Estoque AS me\n" +
